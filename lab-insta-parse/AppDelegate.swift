...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        // TODO: Pt 0 - Initialize Parse SDK
        ...
        // Completed test object in Step 0 (commenting out to not clone)
    ...
    struct GameScore: ParseObject {
        ...
        // Your own customer proeprties
        // All custom proeprties must be optional
    ...
    // OR Implement a custom initializer (OPTIONAL)
    // It's recommended to place customer initializers in an extension
    // to preserve the memberwise initializer.
    
    extension GameScore {
        
        // Use the init to set your customer properties
